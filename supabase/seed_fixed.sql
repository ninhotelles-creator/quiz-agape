...
('f0001', '00000001-0000-0000-0000-000000000000', 'esgotado', 'Estou esgotado e pensando em desistir', '😔', 'O que melhor descreve esse cansaço?', 1),
('f0002', '00000001-0000-0000-0000-000000000000', 'conflitos', 'Enfrento conflitos e pessoas difíceis na igreja', '⚔️', 'Onde está o maior atrito?', 2),
('f0003', '00000001-0000-0000-0000-000000000000', 'crescimento', 'Quero crescer e me preparar melhor como líder', '📈', 'O que você mais quer desenvolver?', 3),
('f0004', '00000001-0000-0000-0000-000000000000', 'crise', 'Estou passando por uma crise emocional ou espiritual', '🌑', 'Como você está por dentro?', 4),

-- apologetica homem adulto (t0002)
('f0005', '00000002-0000-0000-0000-000000000000', 'familia', 'Em casa com filhos ou familiares que estão abandonando a fé', '🏠', 'Qual é sua maior preocupação?', 1),
('f0006', '00000002-0000-0000-0000-000000000000', 'trabalho', 'No trabalho com pessoas que questionam minha fé', '💼', 'Como essa pressão aparece na sua vida?', 2),
('f0007', '00000002-0000-0000-0000-000000000000', 'sofrimento', 'O sofrimento da vida me faz questionar se Deus existe', '💔', 'O que mais te faz questionar?', 3),
('f0008', '00000002-0000-0000-0000-000000000000', 'duvidas', 'Tenho dúvidas internas que nunca resolvi', '🧠', 'O que mais te inquieta?', 4),

-- crise-sofrimento (t0003)
('f0009', '00000003-0000-0000-0000-000000000000', 'luto', 'Perdi algo ou alguém importante e estou de luto', '😢', 'O que você mais precisa agora?', 1),
('f0010', '00000003-0000-0000-0000-000000000000', 'fora-dos-trilhos', 'Sinto que minha vida saiu dos trilhos', '😤', 'Como você chegou até aqui?', 2),
('f0011', '00000003-0000-0000-0000-000000000000', 'solidao', 'Estou me sentindo sozinho e abandonado', '😶', 'O que você mais sente?', 3),
('f0012', '00000003-0000-0000-0000-000000000000', 'fe-abalada', 'O sofrimento está abalando minha fé em Deus', '🤯', 'Como está sua relação com Deus nesse momento?', 4),

-- pai-marido (t0004)
('f0013', '00000004-0000-0000-0000-000000000000', 'casamento', 'Meu casamento precisa de atenção', '💍', 'O que você mais quer construir no seu casamento?', 1),
('f0014', '00000004-0000-0000-0000-000000000000', 'paternidade', 'Quero ser um pai mais presente e intencional', '👨‍👧', 'O que mais te preocupa como pai?', 2),
('f0015', '00000004-0000-0000-0000-000000000000', 'identidade', 'Quero entender melhor meu papel como homem cristão', '💪', 'O que você sente que falta em você?', 3),
('f0016', '00000004-0000-0000-0000-000000000000', 'crise-casamento', 'Meu casamento está em crise ou com conflitos sérios', '⚡', 'Como estão os conflitos no seu casamento?', 4),

-- familia-casamento mulher adulta (t0005)
('f0017', '00000005-0000-0000-0000-000000000000', 'casamento', 'Meu casamento precisa de mais atenção e cuidado', '💍', 'O que você mais quer para seu casamento?', 1),
('f0018', '00000005-0000-0000-0000-000000000000', 'filhos', 'Tenho dificuldades com meus filhos', '👶', 'Qual é seu maior desafio com seus filhos?', 2),
('f0019', '00000005-0000-0000-0000-000000000000', 'espiritualidade', 'Quero ser uma esposa e mãe mais espiritualizada', '🙏', 'O que você quer construir?', 3),
('f0020', '00000005-0000-0000-0000-000000000000', 'familia-ideal', 'Minha família está longe de ser o que eu sonhei', '💔', 'O que mais te pesa?', 4),

-- crise-momentos-dificeis mulher adulta (t0006)
('f0021', '00000006-0000-0000-0000-000000000000', 'ansiedade', 'Estou cheia de ansiedade e medos que não consigo controlar', '😰', 'O que mais te paralisa?', 1),
('f0022', '00000006-0000-0000-0000-000000000000', 'esgotamento', 'Estou emocionalmente esgotada e no limite', '💔', 'Como você está por dentro?', 2),
('f0023', '00000006-0000-0000-0000-000000000000', 'alegria', 'Perdi a alegria e não consigo ser feliz', '😔', 'O que você mais quer recuperar?', 3),
('f0024', '00000006-0000-0000-0000-000000000000', 'ciclos', 'Caio nos mesmos padrões e ciclos sempre', '🔁', 'O que você reconhece em si mesma?', 4),

-- proposito mulher adulta (t0007)
('f0025', '00000007-0000-0000-0000-000000000000', 'descoberta', 'Ainda não sei qual é o meu propósito e chamado', '🌱', 'O que mais te trava?', 1),
('f0026', '00000007-0000-0000-0000-000000000000', 'florescimento', 'Sei quem sou mas não estou florescendo como poderia', '🌸', 'O que você sente que ainda não desabrochou?', 2),
('f0027', '00000007-0000-0000-0000-000000000000', 'identidade', 'Quero me tornar a mulher que Deus criou para eu ser', '👑', 'O que você mais quer desenvolver?', 3),
('f0028', '00000007-0000-0000-0000-000000000000', 'liberdade', 'Estou presa e quero voar mais alto na vida', '🦅', 'O que te prende no chão?', 4),

-- relacionamento-deus mulher adulta (t0008)
('f0029', '00000008-0000-0000-0000-000000000000', 'fria', 'Minha vida devocional está fria e mecânica', '🥶', 'O que você sente que está faltando?', 1),
('f0030', '00000008-0000-0000-0000-000000000000', 'oracao', 'Quero aprender a orar com mais poder e profundidade', '🙏', 'Como é sua vida de oração hoje?', 2),
('f0031', '00000008-0000-0000-0000-000000000000', 'sabedoria', 'Quero me tornar uma mulher mais sábia e bíblica', '📖', 'O que você quer desenvolver?', 3),
('f0032', '00000008-0000-0000-0000-000000000000', 'coragem', 'Quero uma fé mais corajosa e intensa', '🔥', 'O que você quer romper?', 4),

-- ficcao homem jovem (t0009)
('f0033', '00000009-0000-0000-0000-000000000000', 'aventura', 'Histórias de coragem, aventura e superação', '⚔️', 'O que mais te atrai nesse tipo de história?', 1),
('f0034', '00000009-0000-0000-0000-000000000000', 'reflexao', 'Histórias que me fazem pensar e enxergar a vida diferente', '🧠', 'O que você quer que a história desperte em você?', 2),
('f0035', '00000009-0000-0000-0000-000000000000', 'biografias', 'Histórias reais de pessoas que mudaram o mundo', '🌍', 'Que tipo de herói te inspira mais?', 3),
('f0036', '00000009-0000-0000-0000-000000000000', 'classicos', 'Histórias clássicas que marcaram gerações', '📜', 'O que você busca num clássico?', 4),

-- apologetica homem jovem (t0010)
('f0037', '00000010-0000-0000-0000-000000000000', 'academico', 'Na faculdade ou escola com professores e colegas céticos', '🎓', 'Qual é o maior ataque que você enfrenta?', 1),
('f0038', '00000010-0000-0000-0000-000000000000', 'redes-sociais', 'Nas redes sociais e debates online', '📱', 'O que mais te trava nos debates?', 2),
('f0039', '00000010-0000-0000-0000-000000000000', 'mundo-atual', 'Com questões do mundo atual que me deixam sem resposta', '🌍', 'Qual tema te gera mais dúvida ou pressão?', 3),
('f0040', '00000010-0000-0000-0000-000000000000', 'duvidas', 'Dentro de mim mesmo tenho dúvidas que não consigo resolver', '🤔', 'O que mais te inquieta por dentro?', 4),

-- relacionamento-pureza homem jovem (t0011)
('f0041', '00000011-0000-0000-0000-000000000000', 'pureza', 'Luto com pureza sexual e não consigo vencer sozinho', '🔥', 'Como é essa batalha para você?', 1),
('f0042', '00000011-0000-0000-0000-000000000000', 'relacionamento-confuso', 'Estou num relacionamento confuso e sem direção', '💔', 'Onde está a confusão?', 2),
('f0043', '00000011-0000-0000-0000-000000000000', 'preparacao', 'Quero me preparar para um relacionamento que honre a Deus', '💍', 'O que você quer construir?', 3),
('f0044', '00000011-0000-0000-0000-000000000000', 'cultura', 'A cultura me bombardeia com uma visão de sexo que confunde tudo', '🤯', 'O que mais te confunde?', 4),

-- relacionamento-deus homem jovem (t0012)
('f0045', '00000012-0000-0000-0000-000000000000', 'fria', 'Minha fé está fria e virou rotina sem sentido', '🥶', 'O que você sente que está faltando?', 1),
('f0046', '00000012-0000-0000-0000-000000000000', 'vicios', 'Tenho pecados e vícios que me prendem e me envergonham', '⛓️', 'Qual é sua maior luta como homem?', 2),
('f0047', '00000012-0000-0000-0000-000000000000', 'mente', 'Minha mente está caótica e não consigo focar em Deus', '😵', 'O que mais te domina internamente?', 3),
('f0048', '00000012-0000-0000-0000-000000000000', 'conhecer-jesus', 'Não sei se realmente conheço Jesus ou só sei sobre Ele', '❓', 'O que mais te inquieta na sua fé?', 4),

-- ficcao mulher jovem (t0013)
('f0049', '00000013-0000-0000-0000-000000000000', 'romance', 'Histórias de romance, fé e relacionamentos com propósito', '💕', 'O que você quer sentir lendo essa história?', 1),
('f0050', '00000013-0000-0000-0000-000000000000', 'reflexao', 'Histórias que me fazem pensar e enxergar a vida diferente', '🧠', 'O que você quer que a história desperte em você?', 2),
('f0051', '00000013-0000-0000-0000-000000000000', 'biografias', 'Histórias reais de mulheres que marcaram a história', '👑', 'Que tipo de mulher te inspira mais?', 3),
('f0052', '00000013-0000-0000-0000-000000000000', 'classicos', 'Histórias clássicas que marcaram gerações', '📜', 'O que você busca num clássico?', 4),

-- apologetica mulher jovem (t0014) — mesmo fluxo homem jovem
('f0053', '00000014-0000-0000-0000-000000000000', 'academico', 'Na faculdade ou escola com professores e colegas céticos', '🎓', 'Qual é o maior ataque que você enfrenta?', 1),
('f0054', '00000014-0000-0000-0000-000000000000', 'redes-sociais', 'Nas redes sociais e debates online', '📱', 'O que mais te trava nos debates?', 2),
('f0055', '00000014-0000-0000-0000-000000000000', 'mundo-atual', 'Com questões do mundo atual que me deixam sem resposta', '🌍', 'Qual tema te gera mais dúvida ou pressão?', 3),
('f0056', '00000014-0000-0000-0000-000000000000', 'duvidas', 'Dentro de mim mesma tenho dúvidas que não consigo resolver', '🤔', 'O que mais te inquieta por dentro?', 4),

-- relacionamento-pureza mulher jovem (t0015)
('f0057', '00000015-0000-0000-0000-000000000000', 'pureza', 'Luto com pureza sexual e não consigo vencer sozinha', '🔥', 'Como é essa batalha para você?', 1),
('f0058', '00000015-0000-0000-0000-000000000000', 'relacionamento-confuso', 'Estou num relacionamento confuso e sem direção', '💔', 'Onde está a confusão?', 2),
('f0059', '00000015-0000-0000-0000-000000000000', 'preparacao', 'Quero me preparar para um relacionamento que honre a Deus', '💍', 'O que você quer construir?', 3),
('f0060', '00000015-0000-0000-0000-000000000000', 'cultura', 'A cultura me bombardeia com uma visão de sexo que confunde tudo', '🤯', 'O que mais te confunde?', 4),

-- relacionamento-deus mulher jovem (t0016)
('f0061', '00000016-0000-0000-0000-000000000000', 'fria', 'Minha fé está fria e me sinto distante de Deus', '🥶', 'O que você sente que está faltando?', 1),
('f0062', '00000016-0000-0000-0000-000000000000', 'vicios', 'Tenho padrões e vícios que me afastam de Deus', '⛓️', 'Qual é sua maior luta?', 2),
('f0063', '00000016-0000-0000-0000-000000000000', 'emocoes', 'Minhas emoções e ansiedades me dominam mais que Deus', '😵', 'O que mais te domina por dentro?', 3),
('f0064', '00000016-0000-0000-0000-000000000000', 'conhecer-jesus', 'Quero conhecer Jesus de uma forma mais profunda e real', '❓', 'O que você mais quer descobrir?', 4);
